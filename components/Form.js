...
export function SelectionList(props) {
	...
	} else itemWidth = styles.oneColumn;
				...
				<Pressable
					...
					style={[
						...
						selected
							...
							: [styles.hiddenHighlight, styles.hiddenBorder1],
						styles.margin2,
					]}
					...
					{props.iconStyle > 0 && (
						<View
							...
							{getIcon(
								selection.iconFamily,
								selection.iconName,
								selection.iconSize,
								selected ? activeIconColor : styles.colors.gray3
							)}
						</View>
					)}
					<View
			...
			<View style={styles.formHeader}>
				...
				<Pressable style={styles.helpButton}>
					{getIcon(
						...
						'help-circle-outline',
						24,
						props.invert ? styles.whiteColor : styles.colors.gray2
					)}
				</Pressable>
			</View>
			<View style={styles.formBody}>
				<View
					style={[
						props.orientation == 'row' && styles.row,
						props.wrap && styles.wrap,
						styles.spaceBetween,
						optionContent.length == 2 && styles.twoOptions,
					]}>
					{optionContent}
				</View>
			</View>
	...
	return (
		<View style={styles.editField}>
			...
			<View style={[styles.alignedRow, styles.padding4]}>
				<StyledText style={[styles.selectionText, styles.marginRight4]}>
					{'Date: ' + format(date, 'E, MMM do')}
				</StyledText>
				<Button onPress={() => setShow(true)} title={'Edit'} />
				{show && (
					<DateTimePicker
